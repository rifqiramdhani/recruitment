        ...
        <div class="card-body">
            <form action="#" method="post" data-toggle="validator" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="posisi_dibutuhkan" name="posisi_dibutuhkan" data-required-error="Data tidak boleh kosong" required>
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="jumlah_dibutuhkan" name="jumlah_dibutuhkan" data-required-error="Data tidak boleh kosong" required>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <span class="help-block with-errors"></span>
                </div>
