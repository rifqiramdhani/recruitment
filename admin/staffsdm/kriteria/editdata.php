...
$query = mysqli_query($koneksi, "SELECT kriteria.*, nama_kriteria FROM `kriteria` JOIN kriteria_index ON kode_kriteria_fore = kode_kriteria WHERE id_kriteria = '$id' AND id_lowongan_fore = '$id_lowongan'");
