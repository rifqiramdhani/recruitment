...
//monitoring jabatan
$queryjabatan = mysqli_query($koneksi, "SELECT id_dt_jabatan, nama_jabatan, nama_divisi, kebutuhan_karyawan FROM `detail_jabatan` JOIN divisi ON detail_jabatan.id_divisi = divisi.id_divisi JOIN jabatan ON detail_jabatan.id_jabatan = jabatan.id_jabatan");
?>
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								...
								while ($getdatajabatan = mysqli_fetch_assoc($queryjabatan)) :
									...
									$id_dt_jabatan = $getdatajabatan['id_dt_jabatan'];
									...
									$kekosongan = intval($getdatajabatan['kebutuhan_karyawan']) - intval($getjumlahkaryawan['jumlah']);
