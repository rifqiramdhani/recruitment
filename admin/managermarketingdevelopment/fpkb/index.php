                ...
                <table class="table table-striped table-bordered text-center" style="width:100%" id="datakaryawan">
                    ...
                    <tbody>
                        ...
                        while ($getdata = mysqli_fetch_assoc($query)) :
                            ...
                            $querystatus = mysqli_query($koneksi, "SELECT * FROM `fpkb` WHERE id_jabatan = '$id_jabatan' AND status_fpkb <> 3 AND status_fpkb <> 4");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($kekosongan > 0) : ?>
                                        <?php if (mysqli_num_rows($querystatus) == 0) : ?>
                                        ...
                                        <?php else : ?>
                                            <button class="btn btn-block btn-default col-orange btn-sm" title="Telah Mengajukan FPKB"></i>Proses Pengajuan</button>
                                        <?php endif ?>
                                    <?php endif ?>
                                </td>
