...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $keterampilan_khusus = htmlspecialchars(ucwords($_POST['keterampilan_khusus']));
    $job_desc = htmlspecialchars(ucwords($_POST['job_desc']));

    $id_karyawan = $_SESSION['id_karyawan'];
    $date = date('Y-m-d');

    $sql = mysqli_query($koneksi, "INSERT INTO `fpkb`(`id_jabatan`,`id_karyawan`, `posisi_dibutuhkan`, `jumlah_dibutuhkan`, `jumlah_karyawan`, `tanggal_permintaan`, `pendidikan_formal`, `pengalaman`, `kompetensi`, `usia`, `keterampilan_khusus`, `job_desc`) VALUES ('$id_jabatan','$id_karyawan', '$posisi_dibutuhkan', '$jumlah_dibutuhkan', '$jumlah_karyawan' , '$date', '$pendidikan_formal', '$pengalaman', '$kompetensi', '$usia', '$keterampilan_khusus', '$job_desc')");
        ...
        <div class="card-body">
            <form action="#" method="post" data-toggle="validator" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="posisi_dibutuhkan" name="posisi_dibutuhkan" value="<?= $getdata['nama_jabatan'] . ' ' . $getdata['nama_divisi'] ?>" required readonly>
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="jumlah_dibutuhkan" name="jumlah_dibutuhkan" value="<?= $kekosongan ?>" required readonly>
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" id="jumlah_karyawan" name="jumlah_karyawan" value="<?= $getjumlahkaryawan['jumlah'] ?>" required readonly>
                        <div class="input-group-prepend">
                            <span class="input-group-text">Orang</span>
                        </div>
                    </div>
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="pendidikan_formal" name="pendidikan_formal" required>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <span class="help-block with-errors"></span>
                </div>
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="keterampilan_khusus" name="keterampilan_khusus" required>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <span class="help-block with-errors"></span>
                </div>
                ...
                <div class="form-group has-feedback">
                    ...
                    <textarea name="job_desc" id="job_desc" rows="6" class="form-control" required></textarea>
                    <span class="help-block with-errors"></span>
                </div>
