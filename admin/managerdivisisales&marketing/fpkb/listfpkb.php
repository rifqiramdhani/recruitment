...
$query = mysqli_query($koneksi, "SELECT fpkb.*, nama_karyawan, nama_jabatan, nama_divisi FROM `fpkb` JOIN karyawan USING(id_karyawan) JOIN jabatan ON karyawan.id_jabatan = jabatan.id_jabatan JOIN divisi USING(id_divisi) WHERE fpkb.id_karyawan = '$id_karyawan' ORDER BY tanggal_permintaan DESC");
...
<div class="col-12">
    ...
    <a href="?page=fpkb" class="btn btn-warning btn-sm mb-2"><i class="fas fa-reply"></i> Kembali</a>
