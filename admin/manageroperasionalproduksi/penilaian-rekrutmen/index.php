...
$query = mysqli_query($koneksi, "SELECT id_rekrutmen, nama_rekrutmen FROM `rekrutmen` JOIN fpkb USING(id_fpkb) WHERE id_karyawan = '$id_karyawan' AND status_rekrutmen = 0");
