        ...
        <div class="card-body">
            <form action="#" method="post" data-toggle="validator" role="form">
                ...
                <div class="form-group has-feedback">
                    ...
                    <input type="text" class="form-control" id="nama_kriteria_penilaian" name="nama_kriteria_penilaian" pattern="^[_A-z]{1,}$" data-pattern-error="Data hanya boleh huruf saja" data-required-error="Data tidak boleh kosong" required>
                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                    <span class="help-block with-errors"></span>
                </div>
